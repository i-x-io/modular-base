...
| --- | --- | --- |
| P0 release bootstrap | Replace the temporary release-token and maintainer tag bypass with the organization-owned release App. | Complete the interactive App creation, verify one release, then remove the fallback secret and team bypass. |
