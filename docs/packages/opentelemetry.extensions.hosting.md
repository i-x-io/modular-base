...
The source/meter names must match application library declarations. `AddNpgsql()` and `AddNpgsqlInstrumentation()` come from `Npgsql.OpenTelemetry`; its package is cataloged separately.
...
- https://www.nuget.org/packages/OpenTelemetry.Extensions.Hosting/1.17.0
- https://github.com/open-telemetry/opentelemetry-dotnet/tree/main/src/OpenTelemetry.Extensions.Hosting
- https://github.com/open-telemetry/opentelemetry-dotnet/blob/main/docs/builders/add-opentelemetry.md
